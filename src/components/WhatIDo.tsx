          ...
          >
            ...
            <div className="what-content-in">
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Entity Framework Core</div>
                <div className="what-tags">SQL Server</div>
                <div className="what-tags">RESTful APIs</div>
                <div className="what-tags">LINQ</div>
                <div className="what-tags">Authentication & Authorization</div>
                <div className="what-tags">Azure / IIS Deployment</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
